<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="view_assignments.aspx.cs" Inherits="schools_system.teacher_pages.view_assignments" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="style1">
        ...
        <tr>
            <td class="auto-style2"><strong>My Assignments</strong></td>
            <td>
